...
import "./WithdrawalListRejected.css";
import { API_BASE_URL2 } from "../api";

const WithdrawalListRejected = () => {
  ...
  useEffect(() => {
    const fetchRejectedWithdrawals = async () => {
      try {
        const response = await fetch(`${API_BASE_URL2}/withdrawals/rejected`);
        if (!response.ok) {
  ...
  return (
    <div className="withdrawal-list-container">
      ...
      {/* Rejected Withdrawal List Panel */}
      <div className="panel withdrawal-panel">
        <div className="panel-header">Rejected Withdrawal Request</div>
        <div className="panel-content">
          {/* Table Controls */}
                ...
                <tbody>
                  {withdrawalList.length > 0 ? (
                    ...
                    <tr className="no-data-row">
                      <td colSpan="6">No rejected withdrawals available</td>
                    </tr>
                  )}
                </tbody>
              </table>
...
export default WithdrawalListRejected;
